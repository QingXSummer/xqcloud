...
function operateFormatter(value, row, index) {
	console.log(row.processStatus == 0);
    var processType=$('#processType').val();
...
window.operateEvents = {
        'click .like': function (e, value, row, index) {      
        	window.location.href=path+"/page/view/taskInfo/index.jsp?target="+row.url+"&insCode="+row.processInstanceId+"&taskId="+row.currentTaskIdVo;
        },
        'click .edit': function (e, value, row, index) {
        	window.location.href=path+"/page/view/taskInfo/processapprove.jsp?target="+row.url+"&insCode="+row.processInstanceId+"&taskId="+row.currentTaskIdVo;
        }
    };
